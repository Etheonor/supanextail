const Terms = (): JSX.Element => (
  <div className="max-w-xl text-left m-auto py-10">
    ...
    <p>
      ...
      use of <span className="website_url">https://www.Real Estate Buddy.dev</span>, including any
      content, functionality and services offered on or via{' '}
      <span className="website_url">https://www.Real Estate Buddy.dev</span> (the "Website").
    </p>
